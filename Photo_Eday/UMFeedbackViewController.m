...
- (void)customizeNavigationBar:(UINavigationBar *)bar {
    ...
    if ([bar respondsToSelector:@selector(setBackgroundImage:forBarMetrics:)]) {
        UIImage *image = [UIImage imageNamed:@"greenback.png"];
...
//    button.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin;
    button.frame = CGRectMake(270, 7, 45.0f, 30.0f);
    button.titleLabel.textColor = [UIColor grayColor];
    button.titleLabel.font = [UIFont systemFontOfSize:17.0];
    [button setTitle: @"发送" forState:UIControlStateNormal];
    [button setTitleColor:[UIColor grayColor] forState:UIControlStateNormal];
    [button setBackgroundColor:[UIColor whiteColor]];
    [button setBackgroundImage:[UIImage imageNamed:@"graybuttonBK.png"] forState:UIControlStateNormal];
...
- (void)setupTextField {
    _mTextField = [[UITextField alloc] initWithFrame:CGRectMake(6, 7, _mToolBar.frame.size.width - 64.0f, 30.0f)];
...
//    _mTextField.borderStyle = UITextBorderStyleLine;
    ...
    [_mTextField.layer setMasksToBounds:YES];
    [_mTextField.layer setCornerRadius:4];
...
//        UIImage *image = [self imageWithColor:kNavigationBar_ToolBarBackGroundColor];
        UIImage *image = [self imageWithColor:[UIColor groupTableViewBackgroundColor]];
...
//    self.mContactView.backgroundColor = [UIColor orangeColor];
