...
static NSString *FACEPP_API_KEY = @"8e89c910e982956080f58be19a721489";
static NSString *FACEPP_API_SECRET = @"ev1oncbMghwSO0Ab_YL-hDwF6ukh6I33";
...
+(NSString*) generateRequestUrlPrefix: (NSString*) method params: (NSArray*) params {
    ...
    NSMutableString *urlString = [NSMutableString stringWithFormat:@"%@%@?api_key=%@&api_secret=%@&attribute=glass,gender,age,race,smiling", SERVER_ADDRESS, method, FACEPP_API_KEY, FACEPP_API_SECRET];
    if (params != NULL) {
